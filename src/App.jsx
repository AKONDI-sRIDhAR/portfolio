...
          <p>
            **Manav Rachna University**, Faridabad<br />
            Computer Science Engineering<br />
            Specialization: Cybersecurity and Threat Intelligence<br />
            **CGPA: 8.4/10.0**
          </p>
        </div>
        <div className="education-card card">
...
          <p>
            **Sri Chaitanya Junior College**, Kakinada<br />
            Stream: MPC (Physics, Mathematics, Chemistry)<br />
            **Score: 797/1000 (79%)**
          </p>
            </div>
        <div className="education-card card">
...
          <p>
            **Sri Chaitanya Techno Curriculum**, Pithapuram<br />
...
          <a href="#education">Education</a> {/* New Navigation Link */}
...
          <h2>Achievements</h2>
          {/* The grid class is retained, but the content is updated to a 1x3 structure */}
          <div className="achievements-grid three-col-grid"> {/* Added three-col-grid for new CSS targeting */}
            {/* REMOVED 'Academics' Card */}
